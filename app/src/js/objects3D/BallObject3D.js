 ...
 */
function Ball() {
  var texture = new THREE.TextureLoader().load(require("Public/img/texture-ball.png"));
  var textureAlpha = new THREE.TextureLoader().load(require("Public/img/texture-ballAlpha.png"));
  ...
  var appearTween = TweenLite.to({}, 0.1, {
    paused: true,
    onComplete: function() {
      appearTweenCurrent++;
